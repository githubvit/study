...
5、https://github.com/rg3/youtube-dl#output-template

6、https://github.com/rg3/youtube-dl#format-selection

7、https://github.com/rg3/youtube-dl#video-selection-1

8、mpv player搭配youtube-dl，在CMD中设置： set http_proxy=http://127.0.0.1:1080 ，即可在mpv中看YouTube视频。