...
from Ui_selectpage import Ui_Form

# 2 class 多继承 

class SelectpageUi(QWidget,Ui_Form):
    # 自定义信号
    ...
    def __init__(self,parent=None,*args,**kwargs):
        ...
        # 4 信号与槽
        self.items_lst.currentRowChanged.connect(self.change_page)

    # 4 用slot装饰器添加槽函数
    def change_page(self,index):
        # 用列表的行号来改变索引
        self.pages_skt.setCurrentIndex(index)
